...
public class MiniStatement extends JFrame  {
    ...
    MiniStatement(String pinnumber) {
        ...
        JLabel bank = new JLabel("Punjab Bank");
        ...
        try {
            Conn conn = new Conn();
            ResultSet rs = conn.s.executeQuery("selet * from login where pin = '"+pinnumber+"'");
            while (rs.next()) {
        ...
        try {
            ...
            balance.setText("Your current account balance iss Rs " + bal);
        } catch (Exception e) {
            System.out.println(e);
        }
