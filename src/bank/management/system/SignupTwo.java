...
public class SignupTwo extends JFrame implements ActionListener {
    ...
    SignupTwo(String formno){
        ...
        JLabel email = new JLabel("Qualificaltion: ");
        ...
        String occupationValues[] = {"Salaried", "Self-Employed", "Buissness", "Student", "Retired", "Other"};
        ...
        JLabel pincode = new JLabel("Existing: ");
